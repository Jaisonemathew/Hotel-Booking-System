...
exports.postFeedback = (req, res, next) => {
   ...
   var data = "INSERT INTO feedback " +
      " VALUES ( '" + req.body.name + "' ,'" + req.body.mail + "','" + req.body.phone + "','" + req.body.message + "')";

   connectDB.query(data, (err, result) => {
      if (err) throw err;// if db has error, show that 
      else {
         res.render('user/feedback', { user: "", msg: ["Feedback sent successfully"], err: [] }); //show login page
      }
   })
}